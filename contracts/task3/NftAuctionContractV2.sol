...
// 拍卖合约
contract NftAuctionContractV2 is Initializable, UUPSUpgradeable {
...
//     constructor() Ownable(msg.sender) CCIPReceiver(msg.sender){}
    ...
    // place bid
    function placeBid(uint256 _nftTokenId, uint256 tokenAmount, address tokenAddress) public  payable returns(uint256){
